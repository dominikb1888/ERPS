...
<img src="img/laudon_emis14_ppt_ch06_MS-ct0.jpg" width=500px />
...
__6\.5__ How willM I Shelp my career?
...
* Problem
  ...
  * Data fragmented across multiple systems and files
* Solutions
  * Astro Data Lake
...
* Examples: Microsoft Access\,D B 2\, Oracle Database\, MicrosoftS Q LServer\, MySQL
...
SELECT PART\.Part\_Number\, PART\.Part\_Name\, SUPPLIER\.Supplier\_Number\,

SUPPLIER\.Supplier\_Name

FROM PART\, SUPPLIER

WHERE PART\.Suplier\_Number = SUPPLIER\.Supplier\_Number AND

Part\_Number = 137 OR Part\_Number = 150;
...
* Amazon Relational Database Service
  * Offers MyS Q L\, MicrosoftS Q LServer\, Oracle Database engines
...
## Interactive Session – Organizations: DEWA: Evolving Utilities for a Smart City

* Class discussion
  * Identify the main challenge faced by DEWA in this case study\.
  * Explain how people\-based\, organizational\, and technological factors were involved in this challenge\.
  * Why is accurate and consistent data particularly important for DEWA?

---

## How Will M I S Help My Career?

The Business: Global Online Stats
